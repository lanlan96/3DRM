...
# ------------------------------------------------------------------------- GLOBAL CONFIG BEG
FLAGS.checkpoint_path = 'log_scannet/log_rn8_spatial_random/checkpoint.tar'
FLAGS.relation_pair = int(FLAGS.checkpoint_path.split('/')[1].split('_')[1][2:])

FLAGS.relation_type = []
if 'semantic' in FLAGS.checkpoint_path:
    FLAGS.relation_type.append('semantic')
if 'spatial' in FLAGS.checkpoint_path:
    FLAGS.relation_type.append('spatial')
